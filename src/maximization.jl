    ...
    for step = 1:nsteps
        ...
        t_ϕ = @elapsed begin
            ...
            if prior_deprojection_factor != 0
                ΔΩ°_perp = pinv(HΩ°) * gradient(ΔΩ° -> CMBLensing.logprior(dsθ; unmix(dsθ; f°, ΔΩ°...)...), ΔΩ°)[1]
        ...
        push!(history, select((;f°,f,Ω°...,Ω...,ΔΩ°,∇Ω°_logpdf,total_logpdf,α,αmax,logpdf=_logpdf,HΩ°,argmaxf_logpdf_history), history_keys))
